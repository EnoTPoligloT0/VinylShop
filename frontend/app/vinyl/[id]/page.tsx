            ...
            <div className="flex flex-col sm:flex-row gap-10">
                ...
                <div className="flex flex-col justify-between w-full sm:w-3/5 ">
                    <div>
                        ...
                        <p className="text-l font-bold text-primary-deep-purple mb-5">In stock: {vinyl.stock  || 'Out of Stock'}</p>
                    </div>

                    <div className="flex items-center gap-4 mb-6">
                        <div className="flex items-center border border-gray-300 rounded-lg px-4 py-3 text-lg">
                        ...
                        <button
                            className="bg-purple-600 text-white py-3 px-8 rounded-lg text-lg font-medium shadow-md hover:bg-purple-700 transition duration-300 ease-in-out transform hover:scale-105">
                            Add to Cart
                        </button>
                    </div>
